...
import com.flipper.sqlcipher.DatabaseDescriptor;
import com.flipper.sqlcipher.DatabaseDriver;
...
public class SqliteDatabaseDriver extends DatabaseDriver<SqliteDatabaseDriver.SqliteDatabaseDescriptor> {
    ...
    public SqliteDatabaseDriver(final Context context, final String password, final List<String> encryptedDbFileNames) {
        this(
                context,
                new SqliteDatabaseProvider() {
                    ...
                    public List<File> getDatabaseFiles() {
                        ...
                        Set<String> encryptedSet = new HashSet<>(encryptedDbFileNames);
                        for (String databaseName : context.databaseList()) {
                            if (encryptedSet.contains(databaseName)) {
    ...
    public SqliteDatabaseDriver(
            final Context context, final SqliteDatabaseProvider sqliteDatabaseProvider, final String password) {
        this(
                context,
                ...
                new SqliteDatabaseConnectionProvider() {
                    ...
                    public SQLiteDatabase openDatabase(File databaseFile) throws SQLiteException {
                        ...
                        return SQLiteDatabase.openDatabase(databaseFile.getAbsolutePath(), password, null, flags);
                    }
                });
    }
